            ...
            switch (query.dsoType) {
                case Constants.BITSTREAM:
                    ...
                    if (owningItem != null) {
                        ...
                        owningItemUrl = configurationService.getProperty("dspace.ui.url") + "/items/" + owningItem.getID();
                        owningItemName = owningItem.getName();
                    } else {
                        identifier = "id/" + bit.getID();
                        owningItemUrl = configurationService.getProperty("dspace.ui.url") + "/bitstream/" + identifier + "/";
